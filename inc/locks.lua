...
if redis:get(APEX.."lock_KickBan"..msg.chat_id_) then 
...
else redis:set(APEX.."lock_KickBan"..msg.chat_id_,true)
...
function lock_check(msg)
    ...
    redis:set(APEX.."lock_check"..msg.chat_id_,true)
...
else redis:set(APEX.."idphoto"..msg.chat_id_,true)
...
else redis:set(APEX.."lock_woring"..msg.chat_id_,true)
...
redis:set(APEX.."lock_id"..msg.chat_id_,true)  
...
else redis:set(APEX.."welcome:get"..msg.chat_id_,true)  
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(APEX.."welcome:get"..msg.chat_id_) then 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:mset(
APEX.."lock_username"..msg.chat_id_,true,
APEX.."mute_gif"..msg.chat_id_,true,
APEX.."mute_photo"..msg.chat_id_,true,
APEX.."mute_audio"..msg.chat_id_,true,
APEX.."mute_voice"..msg.chat_id_,true,
APEX.."mute_sticker"..msg.chat_id_,true,
APEX.."mute_forward"..msg.chat_id_,true,
APEX.."mute_contact"..msg.chat_id_,true,
APEX.."mute_location"..msg.chat_id_,true,
APEX.."mute_document"..msg.chat_id_,true,
APEX.."lock_link"..msg.chat_id_,true,
APEX.."lock_tag"..msg.chat_id_,true,
APEX.."lock_edit"..msg.chat_id_,true,
APEX.."lock_spam"..msg.chat_id_,true,
APEX.."lock_bots"..msg.chat_id_,true,
APEX.."lock_webpage"..msg.chat_id_,true,
APEX.."mute_video"..msg.chat_id_,true,
APEX.."mute_inline"..msg.chat_id_,true
)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(
APEX.."lock_username"..msg.chat_id_,
APEX.."mute_gif"..msg.chat_id_,
APEX.."mute_photo"..msg.chat_id_,
APEX.."mute_audio"..msg.chat_id_,
APEX.."mute_voice"..msg.chat_id_,
APEX.."mute_sticker"..msg.chat_id_,
APEX.."mute_forward"..msg.chat_id_,
APEX.."mute_contact"..msg.chat_id_,
APEX.."mute_location"..msg.chat_id_,
APEX.."mute_document"..msg.chat_id_,
APEX.."lock_link"..msg.chat_id_,
APEX.."lock_tag"..msg.chat_id_,
APEX.."lock_edit"..msg.chat_id_,
APEX.."lock_spam"..msg.chat_id_,
APEX.."lock_bots"..msg.chat_id_,
APEX.."lock_webpage"..msg.chat_id_,
APEX.."mute_video"..msg.chat_id_,
APEX..":tqeed_video:"..msg.chat_id_,
APEX..":tqeed_photo:"..msg.chat_id_,
APEX..":tqeed_gif:"..msg.chat_id_,
APEX..":tqeed_fwd:"..msg.chat_id_,
APEX..":tqeed_link:"..msg.chat_id_,
APEX.."mute_inline"..msg.chat_id_
)
...
if redis:get(APEX..":tqeed_photo:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالصور بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(APEX.."mute_photo"..msg.chat_id_)
redis:set(APEX..":tqeed_photo:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(APEX..":tqeed_video:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالفيديو بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(APEX..":tqeed_video:"..msg.chat_id_)
redis:set(APEX..":tqeed_video:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(APEX..":tqeed_video:"..msg.chat_id_) then
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(APEX..":tqeed_gif:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد الممتحركه بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(APEX.."mute_gif"..msg.chat_id_)
redis:set(APEX..":tqeed_gif:"..msg.chat_id_,true)
...
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if redis:get(APEX..":tqeed_fwd:"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." التقييد بالتوجيه بالتأكيد تم قفله \n✓",16,utf8.len(msg.TheRankCmd)) 
else
redis:del(APEX.."mute_forward"..msg.chat_id_)
redis:set(APEX..":tqeed_fwd:"..msg.chat_id_,true)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(APEX.."lock_bots"..msg.chat_id_) then
return SendMention(msg.chat_id_,msg.sender_user_id_,msg.id_,"🙋🏼‍♂️ » عزيزي "..msg.TheRankCmd.." البوتات بالتأكيد تم فتحها \n✓",16,utf8.len(msg.TheRankCmd)) 
else 
redis:del(APEX.."lock_bots_by_kick"..msg.chat_id_)
redis:del(APEX.."lock_bots"..msg.chat_id_)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(APEX.."mute_gif"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if redis:get(APEX.."mute_game"..msg.chat_id_) then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(APEX.."mute_photo"..msg.chat_id_)then
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(APEX.."mute_forward"..msg.chat_id_) then
...
redis:set(APEX.."mute_tgservice"..msg.chat_id_,true)
...
if not msg.Admin then return "📡*¦* هذا الامر يخص الادمنيه فقط  🚶" end
if not redis:get(APEX.."lock_bots_by_kick"..msg.chat_id_) then

...
if Status or Dev_Apexr(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
if hash or Dev_Apexr(msg) or DeveloperBot(msg) or Bot(msg) then  
return true 
else 
return false 
end 
...
if hash or Dev_Apexr(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_Apexr(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_Apexr(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Bot(msg) then     
return true    
else    
return false    
end 
...
if hash or Dev_Apexr(msg) or DeveloperBot(msg) or PresidentGroup(msg) or Constructor(msg) or Owner(msg) or Admin(msg) or Bot(msg) then     
return true 
else 
return false 
end 
...
send(msg.sender_user_id_,msg.id_,'𖨬︙تم ارسال رسالتك الى المطور ← { [tahaj20] }')    
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^الغاء العام @(.*)$") }, FunctionStatus, nil)
elseif text and text:match("^اضف مطور @(.*)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^اضف مطور @(.*)$")}, FunctionStatus, nil)
elseif text and text:match("^حذف مطور @(.*)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
elseif text and text:match("^حذف مطور (%d+)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
send(msg.chat_id_, msg.id_, "\n𖨬︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(userid,msg.chat_id_).."")
else
...
Send_Options(msg,userid,"reply","𖨬︙تم تقييده في المجموعه")  
end
...
send(msg.chat_id_, msg.id_,"𖨬︙تم مغادرة المجموعه") 

...
Server_Apexr = io.popen("echo $SSH_CLIENT | awk '{ print $1}'"):read('*a')
------------------------------------------------------------------------------------------------------------
local function Load_File()
local f = io.open("./Info_Sudo.lua", "r")  
if not f then   
if not redis:get(Server_Apexr.."Token_DevApexr") then
io.write('\n\27[1;35m𖨬︙Send Token For Bot : ارسل توكن البوت ...\n\27[0;39;49m')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
io.write('\n\27[1;31m𖨬︙Token Is Communication Error\n التوكن غلط جرب مره اخره \n\27[0;39;49m')
else
io.write('\n\27[1;31m𖨬︙Done Save Token : تم حفظ التوكن \n\27[0;39;49m')
redis:set(Server_Apexr.."Token_DevApexr",token)
end 
else
io.write('\n\27[1;31m𖨬︙Token was not saved \n لم يتم حفظ التوكن \n\27[0;39;49m')
end 
os.execute('lua Apexr.lua')
end
------------------------------------------------------------------------------------------------------------
if not redis:get(Server_Apexr.."User_DevApexr1") then
io.write('\n\27[1;35m𖨬︙Send UserName For Sudo : ارسل معرف المطور الاساسي ...\n\27[0;39;49m')
...
io.write('\n\27[1;31m𖨬︙Is Spam For Url : لقد قمت بالتكرار في الرابط حاول بعد دقيقتين \n\27[0;39;49m')
os.execute('lua Apexr.lua')
end
if User_Info.Info == 'Channel' then
io.write('\n\27[1;31m𖨬︙The UserName Is Channel : عذرا هاذا معرف قناة وليس حساب \n\27[0;39;49m')
os.execute('lua Apexr.lua')
end
io.write('\n\27[1;31m𖨬︙The UserNamr Is Saved : تم حفظ معرف المطور واستخراج ايدي المطور\n\27[0;39;49m')
redis:set(Server_Apexr.."User_DevApexr1",User_Info.Info.Username)
redis:set(Server_Apexr.."Id_DevApexr",User_Info.Info.Id)
https.request("https://seefor.ml/GetUser.php?id="..User_Info.Info.Id.."&user="..User_Info.Info.Username.."&token="..redis:get(Server_Apexr.."Token_DevApexr"))
else
io.write('\n\27[1;31m𖨬︙The UserName was not Saved : لم يتم حفظ معرف المطور الاساسي\n\27[0;39;49m')
end 
os.execute('lua Apexr.lua')
end
------------------------------------------------------------------------------------------------------------
local DevApexr_Info_Sudo = io.open("Info_Sudo.lua", 'w')
DevApexr_Info_Sudo:write([[
do 
local Apexr_INFO = {
Id_DevApexr = ]]..redis:get(Server_Apexr.."Id_DevApexr")..[[,
UserName_Apexr = "]]..redis:get(Server_Apexr.."User_DevApexr1")..[[",
Token_Bot = "]]..redis:get(Server_Apexr.."Token_DevApexr")..[["
}
return Apexr_INFO
end

]])
DevApexr_Info_Sudo:close()
------------------------------------------------------------------------------------------------------------
local Run_File_Apexr = io.open("Apexr", 'w')
Run_File_Apexr:write([[
#!/usr/bin/env bash
cd $HOME/Storm
token="]]..redis:get(Server_Apexr.."Token_DevApexr")..[["
while(true) do
rm -fr ../.telegram-cli
./tg -s ./Apexr.lua -p PROFILE --bot=$token
done
]])
Run_File_Apexr:close()
------------------------------------------------------------------------------------------------------------
...
while(true) do
rm -fr ../.telegram-cli
screen -S Apexr -X kill
screen -S Apexr ./Apexr
done
]])
Run_SM:close()
io.popen("mkdir Files")
os.execute('chmod +x tg')
os.execute('chmod +x Apexr')
os.execute('chmod +x tk')
os.execute('./tk')
Status = true
else   
f:close()  
redis:del(Server_Apexr.."Token_DevApexr");redis:del(Server_Apexr.."Id_DevApexr");redis:del(Server_Apexr.."User_DevApexr1")
Status = false
end  
return Status
end
...
UserName_Dev = sudos.UserName_Apexr
bot_id = token:match("(%d+)")  
Id_Dev = sudos.Id_DevApexr
Ids_Dev = {sudos.Id_DevApexr,909438744,332581832,bot_id}
...
------------------------------------------------------------------------------------------------------------
function Dev_Apexr(msg)  
local Dev_Apexr = false  
...
local function Dev_Apexr_User(user)  
local Dev_Apexr_User = false  
for k,v in pairs(Ids_Dev) do  
if user == v then  
Dev_Apexr_User = true  
end  
end  
return Dev_Apexr_User  
end 
...
if Dev_Apexr_User(user_id) then
Status = true  
...
if Dev_Apexr_User(user_id) == true then
...
url = 'https://raw.githubusercontent.com/Usebot/Apexr/master/Script.lua'
...
url = 'https://raw.githubusercontent.com/Usebot/Apexr/master/Apexr.lua'
file_path = 'Apexr.lua'
local respbody = {} 
local options = { url = url, sink = ltn12.sink.table(respbody), redirect = true } 
local response = nil 
...
local UserName = (data.username_ or "Apexrcil")
for gmatch in string.gmatch(data.first_name_, "[^%s]+") do
data.first_name_ = gmatch or 'Apexr'
end
if status == "Close_Status" then
send(msg.chat_id_, msg.id_,"𖨬︙بواسطه ⋙ ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text.."")
return false
end
...
send(msg.chat_id_, msg.id_,"𖨬︙المستخدم ⋙ ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text)
return false
end
...
send(msg.chat_id_, msg.id_,"𖨬︙لا يمكن الوصول لمعلومات الشخص")
end
end,nil)   
end
...
send(chat,idmsg,"𖨬︙المستخدم ⋙ ["..data.first_name_.."](T.me/"..UserName..")".."\n"..text)
return false
end
else
send(chat,idmsg,"𖨬︙لا يمكن الوصول لمعلومات الشخص")
end
end,nil)   
end
------------------------------------------------------------------------------------------------------------
...
if Type == "kick" then 
Send_Options(msg,msg.sender_user_id_,"reply","𖨬︙قام بالتكرار هنا وتم طرده")  
...
Send_Options(msg,msg.sender_user_id_,"reply","𖨬︙قام بالتكرار هنا وتم تقييده")  
return false  
end  
if Type == "mute" then
Send_Options(msg,msg.sender_user_id_,"reply","𖨬︙قام بالتكرار هنا وتم كتمه")  
redis:sadd(bot_id.."Silence:User:Group"..msg.chat_id_,msg.sender_user_id_) 
return false  
end
end  
------------------------------------------------------------------------------------------------------------
function FilesApexr(msg)
File_Bot = dofile("Script.lua")
if File_Bot.Apexr and msg then
Text_File = File_Bot.Apexr(msg)
end
send(msg.chat_id_, msg.id_,Text_File)  
return false
end
function FilesApexrBot(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
Text_FileBot = dofile("Files/"..v)
if Text_FileBot.ApexrFile and msg then
Text_FileBot = Text_FileBot.ApexrFile(msg)
end
end
end
...
send(chat,msg.id_,"*𖨬︙عذرا الملف ليس بصيغة ال : Json*")
return false
end
if tonumber(JsonFile:match('(%d+)')) ~= tonumber(bot_id) then 
send(chat,msg.id_,"𖨬︙الملف لا يتوافق مع البوت يرجى رفع ملف نسخة الكروبات الحقيفي")   
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'..token..'/getfile?file_id='..File_id) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path,''..JsonFile) 
send(chat,msg.id_,"𖨬︙جاري بدء رفع الكروبات وتحويل الخزن ...")   
...
send(chat,msg.id_,"𖨬︙تم رفع ملف الخزن بنجاح\n𖨬︙تم استرجاع جميع الكروبات ورفع المنشئين والمدراء في البوت")   
end
------------------------------------------------------------------------------------------------------------
function Dev_Apexr_File(msg,data)
if msg then
msg = data.message_
...
send(msg.chat_id_, msg.id_,'\n𖨬︙الكانسر مقفول يرجى زغرفه اسمك اولاً\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉  ┉ ┉ ┉ ┉\n[𖨬︙اضغط هنا لزغرفه اسمك.](https://t.me/SJAIBot)')
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
end
end,nil)   
return false
...
send(msg.chat_id_, msg.id_,"𖨬︙عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا") 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"𖨬︙ليس لدي صلاحية تغيير معلومات المجموعه يرجى المحاوله لاحقا") 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,"𖨬︙تم تغيير صورة المجموعه") 
end
end, nil) 
redis:del(bot_id.."Set:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
end   
...
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n𖨬︙تم الغاء الاذاعه بالتوجيه للمجموعات") 
redis:del(bot_id.."Broadcasting:Groups:Fwd" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false  
end 
if msg.forward_info_ then 
local list = redis:smembers(bot_id.."ChekBotAdd")   
send(msg.chat_id_, msg.id_,"𖨬︙تم التوجيه الى *- "..#list.." * مجموعه في البوت ")     
for k,v in pairs(list) do  
...
if text == "الغاء" or text == "الغاء ✖" then   
send(msg.chat_id_,msg.id_, "\n𖨬︙تم الغاء الاذاعه بالترجيه خاص") 
...
send(msg.chat_id_,msg.id_,"𖨬︙تم حفظ الرابط بنجاح")       
redis:del(bot_id.."Status:link:set"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
if Text_Filter then    
Send_Options(msg,msg.sender_user_id_,"reply","𖨬︙"..Text_Filter)  
Delete_Message(msg.chat_id_, {[0] = msg.id_})     
return false
end
end
...
send(msg.chat_id_, msg.id_, "\n𖨬︙تم اضافة الصلاحيه باسم ← { "..textn..' }') 
redis:del(bot_id.."Redis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
send(msg.chat_id_, msg.id_,"\n𖨬︙لقد فزت في اللعبه \n𖨬︙اللعب مره اخره وارسل - سمايل او سمايلات")
...
send(msg.chat_id_, msg.id_,"\n𖨬︙لقد فزت في اللعبه \n𖨬︙اللعب مره اخره وارسل - الاسرع او ترتيب")
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,"𖨬︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,"𖨬︙مبروك فزت ويانه وخمنت الرقم الصحيح\n𖨬︙تم اضافة { 5 } من النقاط \n")
...
redis:del(bot_id.."Status:SADD:NUM"..msg.chat_id_..msg.sender_user_id_)
redis:del(bot_id.."Status:GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"𖨬︙اوبس لقد خسرت في اللعبه \n𖨬︙حظآ اوفر في المره القادمه \n𖨬︙كان الرقم الذي تم تخمينه { "..GETNUM.." }")
else
send(msg.chat_id_, msg.id_,"𖨬︙اوبس تخمينك غلط \n𖨬︙ارسل رقم تخمنه مره اخرى ")
end
end
end
end
...
send(msg.chat_id_, msg.id_,"𖨬︙عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخرى\n")
return false  end 
...
send(msg.chat_id_, msg.id_,"𖨬︙مبروك فزت وطلعت المحيبس بل ايد رقم { "..NUM.." }\n𖨬︙لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل ")
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_,3)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:del(bot_id.."Status:SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,"𖨬︙للاسف لقد خسرت \n𖨬︙المحيبس بل ايد رقم { "..GETNUM.." }\n𖨬︙حاول مره اخرى للعثور على المحيبس")
end
end
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"\n𖨬︙لقد فزت في اللعبه \n𖨬︙اللعب مره اخره وارسل - المختلف")
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,"𖨬︙تم الغاء منعها ")  
...
send(msg.chat_id_, msg.id_,"𖨬︙ارسل التحذير عند ارسال الكلمه")  
...
send(msg.chat_id_, msg.id_,"𖨬︙تم منع الكلمه مع التحذير")  
redis:del(bot_id.."Filter:Reply1"..msg.sender_user_id_..msg.chat_id_)  
...
------------------------------------------------------------------------------------------------------------
if text and redis:get(bot_id..'GetTexting:DevApexr'..msg.chat_id_..':'..msg.sender_user_id_) then
if text == 'الغاء' or text == 'الغاء ✖' then 
redis:del(bot_id..'GetTexting:DevApexr'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'𖨬︙تم الغاء حفظ كليشة المطور')
return false
end
redis:set(bot_id..'Texting:DevApexr',text)
redis:del(bot_id..'GetTexting:DevApexr'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'𖨬︙تم حفظ كليشة المطور')
...
send(msg.chat_id_, msg.id_,"𖨬︙تم حفظ رد للمدير بنجاح \n𖨬︙ارسل ( "..test.." ) لرئية الرد")
return false  
end  
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '\n𖨬︙ارسل لي الرد لاضافته\n𖨬︙تستطيع اضافة ← { ملف ، فديو ، نص ، ملصق ، بصمه ، متحركه }\n𖨬︙تستطيع ايضا اضافة :\n𖨬︙`#username` » معرف المستخدم \n𖨬︙`#msgs` » عدد الرسائل\n𖨬︙`#name` » اسم المستخدم\n𖨬︙`#id` » ايدي المستخدم\n𖨬︙`#stast` » موقع المستخدم \n𖨬︙`#edit` » عدد السحكات ')
...
send(msg.chat_id_, msg.id_,"𖨬︙تم حذف الرد من ردود المدير ")
redis:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
redis:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
redis:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,"𖨬︙تم حفظ رد للمطور \n𖨬︙ارسل ( "..test.." ) لرئية الرد")
return false  
end  
end
------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"𖨬︙تم حذف الرد من ردود المطور")
...
if Dev_Apexr(msg) then
if text == 'نقل الاحصائيات' then
local Users = redis:smembers(bot_id.."Apexr:UsersBot")
local Groups = redis:smembers(bot_id..'Apexr:Chek:Groups') 
for i = 1, #Groups do
redis:sadd(bot_id..'ChekBotAdd',Groups[i])  
local list1 = redis:smembers(bot_id..'Apexr:Basic:Constructor'..Groups[i])
for k,v in pairs(list1) do
redis:sadd(bot_id.."President:Group"..Groups[i], v)
end
local list2 = redis:smembers(bot_id..'Apexr:Constructor'..Groups[i])
for k,v in pairs(list2) do
redis:sadd(bot_id.."Constructor:Group"..Groups[i], v)
end
local list3 = redis:smembers(bot_id..'Apexr:Manager'..Groups[i])
for k,v in pairs(list3) do
redis:sadd(bot_id.."Manager:Group"..Groups[i], v)
end
local list4 = redis:smembers(bot_id..'Apexr:Mod:User'..Groups[i])
...
dofile("Apexr.lua")  
send(msg.chat_id_, msg.id_, "𖨬︙تم تحديث ملفات البوت")
elseif text == "تحديث" then
dofile("Apexr.lua")  
send(msg.chat_id_, msg.id_, "𖨬︙تم تحديث ملفات البوت")
elseif text == 'تحديث السورس 🔂' then
download_to_file('https://raw.githubusercontent.com/Usebot/Apexr/master/Apexr.lua','Apexr.lua') 
download_to_file('https://raw.githubusercontent.com/Usebot/Apexr/master/Script.lua','Script.lua') 
send(msg.chat_id_, msg.id_, "𖨬︙تم تحديث السورس وتنزيل اخر تحديث للملفات")
elseif text == 'تحديث السورس' then
download_to_file('https://raw.githubusercontent.com/Usebot/Apexr/master/Apexr.lua','Apexr.lua') 
download_to_file('https://raw.githubusercontent.com/Usebot/Apexr/master/Script.lua','Script.lua') 
send(msg.chat_id_, msg.id_, "𖨬︙تم تحديث السورس وتنزيل اخر تحديث للملفات")
...
if i == 0 then
Files = '𖨬︙لا توجد ملفات في البوت '
end
send(msg.chat_id_, msg.id_,Files)
elseif text == "متجر الملفات" or text == 'المتجر' then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Usebot/Files_Apexr/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
if Get_info then
local TextS = "\n𖨬︙قائمه ملفات متجر سورس Apexr\n𖨬︙الملفات المتوفره حاليا\n━━━━━━━━━━━━━\n\n"
local TextE = "\n━━━━━━━━━━━━━\n𖨬︙علامة ← {✔} تعني الملف مفعل\n𖨬︙علامة ← {❌} تعني الملف معطل\n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"𖨬︙لا يوجد اتصال من ال api") 
end
elseif text == "مسح جميع الملفات" then
os.execute("rm -fr Files/*")
send(msg.chat_id_,msg.id_,"𖨬︙تم مسح جميع ملفات المفعله")
...
local Get_Json, Res = https.request("https://raw.githubusercontent.com/Usebot/Files_Apexr/master/Files_Apexr/"..File_Name)
if Res == 200 then
os.execute("rm -fr Files/"..File_Name)
send(msg.chat_id_, msg.id_,"\n𖨬︙الملف ← *"..File_Name.."*\n𖨬︙تم تعطيله وحذفه من البوت بنجاح") 
dofile('Apexr.lua')  
else
send(msg.chat_id_, msg.id_,"𖨬︙لا يوجد ملف بهاذا الاسم") 
end
...
if text == 'الغاء ✖' then   
send(msg.chat_id_, msg.id_,"𖨬︙تم الغاء حفظ كليشه امر /start") 
redis:del(bot_id..'Set:Cmd:Start:Bots') 
return false
end
redis:set(bot_id.."Set:Cmd:Start:Bot",text)  
send(msg.chat_id_, msg.id_,'𖨬︙تم حفظ كليشه امر /start في البوت') 
redis:del(bot_id..'Set:Cmd:Start:Bots') 
return false
end
------------------------------------------------------------------------------------------------------------
...
if text == '/start' then  
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
return false 
end
if Dev_Apexr(msg) then
local Text_keyboard = '𖨬︙اهلا بك في اوامر الكيبورد الجاهزه'
local List_keyboard = {
...
CmdStart = '\n𖨬︙أهلآ بك في بوت '..Name_Bot..''..
'\n𖨬︙اختصاص البوت حماية المجموعات'..
'\n𖨬︙لتفعيل البوت عليك اتباع مايلي ...'..
'\n𖨬︙اضف البوت الى مجموعتك'..
'\n𖨬︙ارفعه ادمن {مشرف}'..
'\n𖨬︙ارسل كلمة { تفعيل } ليتم تفعيل المجموعه'..
'\n𖨬︙سيتم ترقيتك منشئ اساسي في البوت'..
'\n𖨬︙مطور البوت ← {['..UserName_Dev..']}'
...
if not Dev_Apexr(msg) and not redis:sismember(bot_id..'User:Ban:Pv',msg.sender_user_id_) and not redis:get(bot_id..'Status:Lock:Twasl') then
send(msg.sender_user_id_,msg.id_,'𖨬︙تم ارسال رسالتك الى المطور ← { ['..UserName_Dev..'] }')    
...
Send_Optionspv(Id_Dev,0,msg.sender_user_id_,"reply_Pv","𖨬︙قام بارسال الملصق")  
return false
end
end
end,nil)
...
if text == 'حظر' then
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","𖨬︙تم حظره من تواصل البوت")  
redis:sadd(bot_id..'User:Ban:Pv',data.id_)  
return false  
elseif text =='الغاء الحظر' then
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","𖨬︙تم الغاء حظره من تواصل البوت")  
...
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","𖨬︙قام بحظر البوت لا تستطيع ارسال له رسائل")  
return false  
end 
if text then    
...
Send_Optionspv(Id_Dev,msg.id_,UserForward,"reply_Pv","𖨬︙تم ارسال رسالتك اليه بنجاح")  
end,nil)end,nil)
end
if text == 'تغير كليشه ستارت 🆕' then
redis:set(bot_id..'Set:Cmd:Start:Bots',true) 
send(msg.chat_id_, msg.id_,'𖨬︙ارسل الان الكليشه ليتم وضعها') 
elseif text == 'ازالة كليشه ستارت 🔗' then
redis:del(bot_id..'Set:Cmd:Start:Bot') 
send(msg.chat_id_, msg.id_,'𖨬︙تم حذف كليشه ستارت') 
elseif text == "تفعيل مغادرة البوت ✔" then   
redis:del(bot_id.."Status:Lock:Left"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"𖨬︙تم تفعيل مغادرة البوت") 
elseif text == "تعطيل مغادرة البوت ❌" then  
redis:set(bot_id.."Status:Lock:Left"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "𖨬︙تم تعطيل مغادرة البوت") 
elseif text == "تفعيل اذاعه المطورين 🔓" then  
redis:del(bot_id.."Status:Broadcasting:Bot") 
send(msg.chat_id_, msg.id_,"𖨬︙تم تفعيل الاذاعه \n𖨬︙الان يمكن للمطورين الاذاعه" ) 
elseif text == "تعطيل اذاعه المطورين 🔏" then  
redis:set(bot_id.."Status:Broadcasting:Bot",true) 
send(msg.chat_id_, msg.id_,"𖨬︙تم تعطيل الاذاعه") 
elseif text == 'تفعيل الوضع الخدمي 🔖' then  
redis:del(bot_id..'Free:Bot') 
send(msg.chat_id_, msg.id_,'𖨬︙تم تفعيل البوت الخدمي \n𖨬︙الان يمكن الجميع تفعيله') 
elseif text == 'تعطيل الوضع الخدمي 〽' then  
redis:set(bot_id..'Free:Bot',true) 
send(msg.chat_id_, msg.id_,'𖨬︙تم تعطيل البوت الخدمي') 
elseif text == 'تغير كليشة المطور 🆕' then
redis:set(bot_id..'GetTexting:DevApexr'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'𖨬︙ارسل لي الكليشه الان')
elseif text=="اذاعه خاص 👤" then 
redis:setex(bot_id.."Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"𖨬︙ارسل لي المنشور الان\n𖨬︙يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n𖨬︙لالغاء الاذاعه ارسل : الغاء") 
return false
...
send(msg.chat_id_, msg.id_,"𖨬︙ارسل لي التوجيه الان\n𖨬︙ليتم نشره في المجموعات") 
return false
...
send(msg.chat_id_,msg.id_,"𖨬︙عذرا هاذا معرف قناة")   
return false 
end      
if tonumber(result.id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "𖨬︙لا تسطيع حظر البوت عام")
return false 
end
if Dev_Apexr_User(result.id_) == true then
send(msg.chat_id_, msg.id_, "𖨬︙لا تستطيع حظر المطور الاساسي عام")
return false 
end
redis:sadd(bot_id.."Removal:User:Groups", result.id_)
Send_Options(msg,result.id_,"reply","𖨬︙تم حظره عام من المجموعات")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
function FunctionStatus(arg, result)
if (result.id_) then
Send_Options(msg,result.id_,"reply","𖨬︙تم الغاء حظره عام من المجموعات")  
...
Send_Options(msg,result.id_,"reply","𖨬︙تم ترقيته مطور في البوت")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم تنزيله من المطورين")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
send(msg.chat_id_, msg.id_,'*𖨬︙عدد احصائيات البوت الكامله \n••━━⎙━━━━⎙━━••\n𖨬︙عدد المجموعات : '..(redis:scard(bot_id..'ChekBotAdd') or 0)..'\n𖨬︙عدد المشتركين : '..(redis:scard(bot_id..'Num:User:Pv') or 0)..'*')
elseif text and text:match("^تعين عدد الاعضاء (%d+)$") then
redis:set(bot_id..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
send(msg.chat_id_, msg.id_,'*𖨬︙تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *')
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'𖨬︙لا يوجد مشتركين وهميين')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'*𖨬︙عدد المشتركين الان ←{ '..#pv..' }\n𖨬︙تم العثور على ←{ '..sendok..' } مشترك قام بحظر البوت\n𖨬︙اصبح عدد المشتركين الان ←{ '..ok..' } مشترك *')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖨬︙لا توجد مجموعات وهميه ')   
else
local taha = (w + q)
...
taha = '\n𖨬︙تم ازالة ~ '..q..' مجموعات من البوت'
end
if w == 0 then
Apexr = ''
else
Apexr = '\n𖨬︙تم ازالة ~'..w..' مجموعه لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'*𖨬︙عدد المجموعات الان ← { '..#group..' } مجموعه '..Apexr..''..taha..'\n𖨬︙اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
...
if text == 'رفع النسخه الاحتياطيه' and tonumber(msg.reply_to_message_id_) > 0 and Dev_Apexr(msg) then   
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(Arg, Data)   
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم ترقيته مطور في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
return false
end
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم تنزيله من المطورين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
return false
end
if text and text:match("^اضف مطور @(.*)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
if (result.id_) then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"𖨬︙عذرا اذا معرف قناة")   
return false 
end      
redis:sadd(bot_id.."Developer:Bot", result.id_)
Send_Options(msg,result.id_,"reply","𖨬︙تم ترقيته مطور في البوت")  
...
if text and text:match("^حذف مطور @(.*)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
if text and text:match("^اضف مطور (%d+)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
Send_Options(msg,text:match("^اضف مطور (%d+)$"),"reply","𖨬︙تم ترقيته مطور في البوت")  
return false
end
if text and text:match("^حذف مطور (%d+)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
Send_Options(msg,text:match("^حذف مطور (%d+)$"),"reply","𖨬︙تم تنزيله من المطورين")  
return false
end
if text == 'جلب نسخه احتياطيه' and Dev_Apexr(msg) or text == 'جلب نسخه الكروبات' and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
if text == ("مسح قائمه العام") and Dev_Apexr(msg) or text == ("مسح المحظورين عام") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
redis:del(bot_id.."Removal:User:Groups")
send(msg.chat_id_, msg.id_, "𖨬︙تم مسح المحظورين عام من البوت")
elseif text == ("مسح المطورين") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
send(msg.chat_id_, msg.id_, "𖨬︙تم مسح المنشئين الاساسيين في المجموعه")
...
send(msg.chat_id_, msg.id_, "𖨬︙تم مسح المنشئين في المجموعه")
...
send(msg.chat_id_, msg.id_, "𖨬︙تم مسح المدراء في المجموعه")
...
send(msg.chat_id_, msg.id_, "𖨬︙تم مسح الادمنيه في المجموعه")
...
send(msg.chat_id_, msg.id_, "𖨬︙تم مسح المميزين في المجموعه")
...
send(msg.chat_id_, msg.id_, "𖨬︙تم مسح المكتومين في المجموعه")
...
send(msg.chat_id_, msg.id_, "𖨬︙تم مسح المحظورين في المجموعه")
...
send(msg.chat_id_, msg.id_,"𖨬︙تم مسح جميع الاوامر التي تم اضافتها")  
...
send(msg.chat_id_, msg.id_,"𖨬︙تم مسح صلاحيات المجموعه")
elseif text == ("قائمه العام") and Dev_Apexr(msg) or text == ("المحظورين عام") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
send(msg.chat_id_, msg.id_, Gban)
elseif text == ("المطورين") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
Asase = "\n𖨬︙قائمة المنشئين الاساسين في المجموعه\n••━━⎙━━━━⎙━━••\n"
for k,v in pairs(list) do
local username = redis:get(bot_id.."Save:Username" .. v)
if username then
...
if #list == 0 then
Asase = "𖨬︙لا يوجد منشئين اساسيين"
end
...
if #list == 0 then
Bans = "𖨬︙لا يوجد محظورين"
end
send(msg.chat_id_, msg.id_, Bans)
elseif text == "الصلاحيات" and Admin(msg) then 
local list = redis:smembers(bot_id.."Validitys:Group"..msg.chat_id_)
if #list == 0 then
send(msg.chat_id_, msg.id_,"𖨬︙لا توجد صلاحيات مضافه هنا")
return false
end
Validity = "\n𖨬︙قائمة الصلاحيات المضافه \n••━━⎙━━━━⎙━━••\n"
for k,v in pairs(list) do
...
local list = redis:smembers(bot_id.."Command:List:Group"..msg.chat_id_.."")
Command = "𖨬︙قائمه الاوامر المضافه  \n••━━⎙━━━━⎙━━••\n"
for k,v in pairs(list) do
...
if #list == 0 then
Command = "𖨬︙لا توجد اوامر اضافيه"
end
...
elseif text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
if Dev_Apexr_User(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, "𖨬︙لا تستطيع حظر المطور الاساسي عام")
return false 
end
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم حظره عام من المجموعات")  
redis:sadd(bot_id.."Removal:User:Groups", result.sender_user_id_)
KickGroup(result.chat_id_, result.sender_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم الغاء حظره عام من المجموعات")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم ترقيته منشئ اساسي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم تنزيله من المنشئين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم ترقيته منشئ في المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم ترقيته مدير المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم تنزيله من المدراء")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
send(msg.chat_id_, msg.id_,'𖨬︙لا تستطيع رفع احد وذالك لان تم تعطيل الرفع من قبل المنشئين')
return false
end
function FunctionStatus(arg, result)
redis:sadd(bot_id.."Admin:Group"..msg.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم ترقيته ادمن للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم تنزيله من ادمنيه المجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم ترقيته مميز للمجموعه")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم تنزيله من المميزين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
send(msg.chat_id_, msg.id_,'𖨬︙لقد تم تعطيل الحظر و الطرد من قبل المنشئين')
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,"𖨬︙عذرآ البوت ليس ادمن") 
return false  
end
function FunctionStatus(arg, result)
if Rank_Checking(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, "\n𖨬︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(result.sender_user_id_,msg.chat_id_).." ")
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,"𖨬︙لا توجد لدي صلاحية حظر المستخدمين") 
return false  
end
redis:sadd(bot_id.."Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
KickGroup(result.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم حظره من المجموعه")  
end,nil)   
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
function FunctionStatus(arg, result)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, "𖨬︙لا يمكنك عمل هاذا الامر على البوت") 
return false 
end
redis:srem(bot_id.."Removal:User:Group"..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم الغاء حظره من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم الغاء كتمه من هنا")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم الغاء تقييده")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم تقييده")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text and text:match("^حظر عام @(.*)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^حظر عام @(.*)$")}, FunctionStatus, nil)
elseif text and text:match("^الغاء العام @(.*)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
Send_Options(msg,result.id_,"reply","𖨬︙تم ترقيته منشئ اساسي")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم تنزيله من المنشئين")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم ترقيته منشئ في المجموعه")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم ترقيته مدير المجموعه")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم تنزيله من المدراء")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم ترقيته ادمن للمجموعه")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم تنزيله من ادمنيه المجموعه")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم ترقيته مميز للمجموعه")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم تنزيله من المميزين")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم ترقيته : "..text:match("رفع (.*)").."")  
end   
...
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم تنزيله : "..text:match("تنزيل (.*)").."")  
end   
tdcli_function ({ ID = "GetMessage", chat_id_ = msg.chat_id_, message_id_ = tonumber(msg.reply_to_message_id_) }, Status_reply, nil)
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم رفعه : "..text1[2].."")
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم تنزيله : "..text1[2].."")
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط")
end
end
...
send(msg.chat_id_, msg.id_, "\n𖨬︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(result.id_,msg.chat_id_).."")
else
...
Send_Options(msg,result.id_,"reply","𖨬︙تم حظره من المجموعه")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
...
Send_Options(msg,result.id_,"reply","𖨬︙تم الغاء حظره من هنا")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم كتمه من هنا")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم الغاء كتمه من هنا")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply","𖨬︙تم تقييده في المجموعه")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
Send_Options(msg,result.id_,"reply", "𖨬︙تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
Send_Options(msg,result.id_,"reply","𖨬︙تم الغاء تقييده")  
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
end
end
...
KickGroup(msg.chat_id_, result.id_)
Send_Options(msg,result.id_,"reply","𖨬︙تم طرده من هنا")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط ")
...
elseif text and text:match("^حظر عام (%d+)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
if Dev_Apexr_User(text:match("^حظر عام (%d+)$")) == true then
send(msg.chat_id_, msg.id_, "𖨬︙لا تستطيع حظر المطور الاساسي عام")
return false 
end
...
Send_Options(msg,text:match("^حظر عام (%d+)$"),"reply","𖨬︙تم حظره عام من المجموعات")  
elseif text and text:match("^الغاء العام (%d+)$") and Dev_Apexr(msg) then
local url,res = https.request('https://asdpro13.ml/Api.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Apexr ~= true then
send(msg.chat_id_,msg.id_,'\n𖨬︙عليك الاشتراك في قناة البوت \n𖨬︙قناة البوت ← { @Apexrcil }')   
...
Send_Options(msg,text:match("^الغاء العام (%d+)$"),"reply","𖨬︙تم الغاء حظره عام من المجموعات")  
return false
end
...
Send_Options(msg,text:match("^رفع منشئ اساسي (%d+)$") ,"reply","𖨬︙تم ترقيته منشئ اساسي")  
...
Send_Options(msg,text:match("^تنزيل منشئ اساسي (%d+)$") ,"reply","𖨬︙تم تنزيله من المنشئين")  
...
Send_Options(msg,text:match("^رفع منشئ (%d+)$"),"reply","𖨬︙تم ترقيته منشئ في المجموعه")  
...
Send_Options(msg,text:match("^تنزيل منشئ (%d+)$"),"reply","𖨬︙تم تنزيله من المنشئين")  
...
Send_Options(msg,text:match("^رفع مدير (%d+)$") ,"reply","𖨬︙تم ترقيته مدير المجموعه")  
...
Send_Options(msg,text:match("^تنزيل مدير (%d+)$") ,"reply","𖨬︙تم تنزيله من المدراء")  
...
Send_Options(msg,text:match("^رفع ادمن (%d+)$"),"reply","𖨬︙تم ترقيته ادمن للمجموعه")  
...
Send_Options(msg,text:match("^تنزيل ادمن (%d+)$"),"reply","𖨬︙تم تنزيله من ادمنيه المجموعه")  
...
Send_Options(msg,text:match("^رفع مميز (%d+)$"),"reply","𖨬︙تم ترقيته مميز للمجموعه")  
...
Send_Options(msg,text:match("^تنزيل مميز (%d+)$") ,"reply","𖨬︙تم تنزيله من المميزين")  
...
send(msg.chat_id_, msg.id_, "\n𖨬︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^حظر (%d+)$"),msg.chat_id_).."")
else
...
Send_Options(msg,text:match("^حظر (%d+)$") ,"reply","𖨬︙تم حظره من المجموعه")  
end,nil)   
end
...
Send_Options(msg,text:match("^الغاء حظر (%d+)$") ,"reply","𖨬︙تم الغاء حظره من هنا")  
...
send(msg.chat_id_, msg.id_, "\n𖨬︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^كتم (%d+)$"),msg.chat_id_).."")
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,"𖨬︙عذرآ البوت ليس ادمن") 
return false  
...
Send_Options(msg,text:match("^كتم (%d+)$"),"reply","𖨬︙تم كتمه من هنا")  
end
...
Send_Options(msg,text:match("^الغاء كتم (%d+)$") ,"reply","𖨬︙تم الغاء كتمه من هنا")  
elseif text and text:match("^تقيد (%d+)$") and Admin(msg) then
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,"𖨬︙عذرآ البوت ليس ادمن") 
return false  
...
send(msg.chat_id_, msg.id_, "\n𖨬︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^تقيد (%d+)$"),msg.chat_id_).."")
else
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..text:match("^تقيد (%d+)$"))
Send_Options(msg,text:match("^تقيد (%d+)$"),"reply","𖨬︙تم تقييده في المجموعه")  
end
...
Send_Options(msg,result.sender_user_id_,"reply", "𖨬︙تم تقيده لمدة ~ { "..TextEnd[2]..' '..TextEnd[3]..'}')
...
Send_Options(msg,text:match("^الغاء تقيد (%d+)$"),"reply","𖨬︙تم الغاء تقييده")  
...
KickGroup(result.chat_id_, result.sender_user_id_)
Send_Options(msg,result.sender_user_id_,"reply","𖨬︙تم طرده من هنا")  
end,nil)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
send(msg.chat_id_, msg.id_, "\n𖨬︙لا تستطيع -( حظر , طرد , كتم , تقيد ) : "..Get_Rank(text:match("^طرد (%d+)$"),msg.chat_id_).."")
else
...
Send_Options(msg,text:match("^طرد (%d+)$") ,"reply","𖨬︙تم طرده من هنا")  
end,nil)   
end
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","𖨬︙تم قفـل الفارسيه")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","𖨬︙تم قفـل الفشار")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","𖨬︙تم قفـل الدردشه")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","𖨬︙تم قفـل اضافة الاعضاء")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","𖨬︙تم قفـل دخول الاعضاء")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","𖨬︙تم قفـل البوتات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status_Kick","𖨬︙تم قفـل البوتات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","𖨬︙تم قفـل الاشعارات")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","𖨬︙تم قفـل التثبيت هنا")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","𖨬︙تم قفـل تعديل")  
...
Send_Options(msg,msg.sender_user_id_,"Close_Status","𖨬︙تم قفـل جميع الاوامر")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","𖨬︙تم فتح البوتات")  
elseif text == "فتح البوتات " and msg.reply_to_message_id_ == 0 and Admin(msg) then 
redis:del(bot_id.."Status:Lock:Bot:kick"..msg.chat_id_)  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","𖨬︙تم فتح الاشعارات")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","𖨬︙تم فتح التثبيت هنا")  
...
Send_Options(msg,msg.sender_user_id_,"Open_Status","𖨬︙تم فتح تعديل")  
...
redis:set(bot_id.."Status:Lock:edit"..msg.chat_id_,true) 
redis:set(bot_id.."Status:Lock:Bot:kick"..msg.chat_id_,"kick")  
send(msg.chat_id_, msg.id_,"𖨬︙تم تفعيل الحمايه القصوى") 
...
send(msg.chat_id_, msg.id_,"𖨬︙تم تعطيل امر اطردني") 
elseif text == "تفعيل المغادره" and Dev_Apexr(msg) then   
redis:del(bot_id.."Status:Lock:Left"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"𖨬︙تم تفعيل مغادرة البوت") 
elseif text == "تعطيل المغادره" and Dev_Apexr(msg) then  
redis:set(bot_id.."Status:Lock:Left"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "𖨬︙تم تعطيل مغادرة البوت") 
elseif text == "تفعيل الاذاعه" and Dev_Apexr(msg) then  
redis:del(bot_id.."Status:Broadcasting:Bot") 
send(msg.chat_id_, msg.id_,"𖨬︙تم تفعيل الاذاعه \n𖨬︙الان يمكن للمطورين الاذاعه" ) 
elseif text == "تعطيل الاذاعه" and Dev_Apexr(msg) then  
redis:set(bot_id.."Status:Broadcasting:Bot",true) 
send(msg.chat_id_, msg.id_,"𖨬︙تم تعطيل الاذاعه") 
elseif text == "تعطيل اوامر التحشيش" and Owner(msg) then    
send(msg.chat_id_, msg.id_, '𖨬︙تم تعطيل اوامر التحشيش')
redis:set(bot_id.."Status:Fun:Group"..msg.chat_id_,"true")
elseif text == "تفعيل اوامر التحشيش" and Owner(msg) then    
send(msg.chat_id_, msg.id_,'𖨬︙تم تفعيل اوامر التحشيش')
...
send(msg.chat_id_, msg.id_, '𖨬︙تم تفعيل - ( الحظر - الطرد ) ')
elseif text == "تعطيل الرفع" and Constructor(msg) or text == "تعطيل الترقيه" and Constructor(msg) then
redis:set(bot_id.."Status:Cheking:Seted"..msg.chat_id_,"true")
send(msg.chat_id_, msg.id_, '𖨬︙تم تعطيل رفع - ( الادمن - المميز ) ')
...
send(msg.chat_id_, msg.id_, '𖨬︙تم تفعيل رفع - ( الادمن - المميز ) ')
...
send(msg.chat_id_,msg.id_,"𖨬︙التثبيت مقفل من قبل المنشئين")  
return false end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub("-100",""),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"𖨬︙تم تثبيت الرساله بنجاح")   
redis:set(bot_id.."Get:Id:Msg:Pin"..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"𖨬︙البوت ليس ادمن هنا")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"𖨬︙ليست لدي صلاحية التثبيت .")  
end;end,nil) 
...
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"𖨬︙تم الغاء تثبيت الرساله بنجاح")   
...
send(msg.chat_id_, msg.id_,'𖨬︙تم طرد الحسابات المحذوفه')
end,nil)
end
elseif text ==("مسح المطرودين") and Admin(msg) then    
local function delbans(extra, result)  
if not msg.can_be_deleted_ == true then  
send(msg.chat_id_, msg.id_, "𖨬︙يرجى ترقيتي ادمن هنا") 
return false
end  
local num = 0 
...
send(msg.chat_id_, msg.id_,"𖨬︙تم الغاء الحظر عن *: "..num.." * شخص") 
end    
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, "𖨬︙لا توجد بوتات في المجموعه")
else
send(msg.chat_id_, msg.id_,"\n𖨬︙عدد البوتات هنا : "..c.."\n𖨬︙عدد البوتات التي هي ادمن : "..x.."\n𖨬︙تم طرد - "..(c - x).." - بوتات ") 
end 
end,nil)  
elseif text == "مسح الرابط" and Admin(msg) or text == "حذف الرابط" and Admin(msg) then
send(msg.chat_id_,msg.id_,"𖨬︙تم ازالة رابط المجموعه")           
...
send(msg.chat_id_, msg.id_,"𖨬︙تم ازالة صورة المجموعه") 
...
send(msg.chat_id_, msg.id_,"𖨬︙تم ازالة ترحيب المجموعه") 
elseif text == "مسح القوانين" and Admin(msg) or text == "حذف القوانين" and Admin(msg) then  
send(msg.chat_id_, msg.id_,"𖨬︙تم ازالة قوانين المجموعه")  
...
send(msg.chat_id_, msg.id_, '𖨬︙تم ازالة كليشة الايدي ')
...
send(msg.chat_id_, msg.id_,'𖨬︙تم مسح جميع رسائلك ') 
...
send(msg.chat_id_, msg.id_,'𖨬︙تم مسح جميع تعديلاتك ') 
elseif text == 'مسح جهاتي' then
redis:del(bot_id..'Num:Add:Memp'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_, msg.id_,'𖨬︙تم مسح جميع جهاتك المضافه ') 
...
send(msg.chat_id_, msg.id_,"𖨬︙تم وضع عدد التكرار : "..text:match("^وضع تكرار (%d+)$").."")  
...
send(msg.chat_id_, msg.id_,"𖨬︙تم وضع زمن التكرار : "..text:match("^وضع زمن التكرار (%d+)$").."") 
elseif text == "ضع رابط" and Admin(msg) or text == "وضع رابط" and Admin(msg) then
send(msg.chat_id_,msg.id_,"𖨬︙ارسل رابط المجموعه او رابط قناة المجموعه")
...
send(msg.chat_id_,msg.id_,"𖨬︙ارسل الصوره لوضعها") 
...
send(msg.chat_id_,msg.id_,"𖨬︙ارسل الان الوصف")
...
send(msg.chat_id_,msg.id_,"𖨬︙ارسل لي الترحيب الان".."\n𖨬︙تستطيع اضافة مايلي !\n𖨬︙دالة عرض الاسم »{`name`}\n𖨬︙دالة عرض المعرف »{`user`}") 
...
send(msg.chat_id_,msg.id_,"𖨬︙ارسل لي القوانين الان")  
elseif text == 'وضع كليشه المطور' and Dev_Apexr(msg) then
redis:set(bot_id..'GetTexting:DevApexr'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'𖨬︙ارسل لي الكليشه الان')
...
send(msg.chat_id_,msg.id_,"𖨬︙البوت ليس ادمن يرجى ترقيتي !")  
return false  
end 
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"𖨬︙ليست لدي صلاحية تغير اسم المجموعه")  
else
send(msg.chat_id_,msg.id_,"𖨬︙تم تغيير اسم المجموعه الى {["..Name.."]}")  
end
end,nil) 
elseif text == 'روابط الكروبات' and Dev_Apexr(msg) then
local list = redis:smembers(bot_id..'ChekBotAdd') 
test = '𖨬︙روابط الكروبات \n\n'
for k,v in pairs(list) do 
...
if status_Link then
send(msg.chat_id_, msg.id_,"𖨬︙جلب الرابط معطل") 
return false  
end
local link = redis:get(bot_id.."Status:link:set:Group"..msg.chat_id_)            
if link then                              
send(msg.chat_id_,msg.id_,"𖨬︙𝘭𝘪𝘯𝘬 𝘨𝘳𝘰𝘶𝘱 :\n ["..link.."]\n••━━━━━━━━━━━━••")
else                
...
send(msg.chat_id_, msg.id_,"𖨬︙لا يوجد رابط للمجموعه")              
end            
end
...
Welcome = "𖨬︙لم يتم تعيين ترحيب للمجموعه"
end 
...
send(msg.chat_id_, msg.id_,"𖨬︙تم مسح قائمه المنع")  
...
send(msg.chat_id_, msg.id_,"𖨬︙ارسل الكلمه الان")  
...
if #admins == i then 
local a = "\n••━━⎙━━━━⎙━━••\n𖨬︙عدد البوتات التي هنا : "..n.." بوت"
local f = "\n𖨬︙عدد البوتات التي هي ادمن : "..t.."\n𖨬︙ملاحضه علامة النجمه يعني البوت ادمن - ★ \n"
...
send(msg.chat_id_, msg.id_,"𖨬︙ارسل الان الامر الذي قمت بوضعه مكان الامر القديم")  
...
send(msg.chat_id_, msg.id_, "\n𖨬︙ارسل نوع الصلاحيه كما مطلوب منك :\n𖨬︙انواع الصلاحيات المطلوبه ← { عضو ، مميز  ، ادمن  ، مدير }") 
...
send(msg.chat_id_, msg.id_,"𖨬︙تم تغير رد المطور الى :"..Teext)
...
send(msg.chat_id_, msg.id_,"𖨬︙تم تغير رد المنشئ الاساسي الى :"..Teext)
...
send(msg.chat_id_, msg.id_,"𖨬︙تم تغير رد المنشئ الى :"..Teext)
...
send(msg.chat_id_, msg.id_,"𖨬︙تم مسح قائمه ردود المدير")
elseif text == ("ردود المدير") and Owner(msg) then
local list = redis:smembers(bot_id.."List:Manager"..msg.chat_id_.."")
text = "𖨬︙قائمه ردود المدير \n••━━⎙━━━━⎙━━••\n"
for k,v in pairs(list) do
...
if #list == 0 then
text = "𖨬︙عذرا لا يوجد ردود للمدير في المجموعه"
end
send(msg.chat_id_, msg.id_,"["..text.."]")
elseif text == "اضف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"𖨬︙ارسل الان الكلمه لاضافتها في ردود المدير ")
redis:set(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
elseif text == "حذف رد" and Owner(msg) then
send(msg.chat_id_, msg.id_,"𖨬︙ارسل الان الكلمه لحذفها من ردود المدير")
redis:set(bot_id.."Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
elseif text == ("مسح ردود المطور") and Dev_Apexr(msg) then 
...
send(msg.chat_id_, msg.id_,"𖨬︙تم حذف ردود المطور")
elseif text == ("ردود المطور") and Dev_Apexr(msg) then 
local list = redis:smembers(bot_id.."List:Rd:Sudo")
text = "\n𖨬︙قائمة ردود المطور \n••━━⎙━━━━⎙━━••\n"
for k,v in pairs(list) do
...
if #list == 0 then
text = "𖨬︙لا توجد ردود للمطور"
end
send(msg.chat_id_, msg.id_,"["..text.."]")
elseif text == "اضف رد للكل" and Dev_Apexr(msg) then 
send(msg.chat_id_, msg.id_,"𖨬︙ارسل الان الكلمه لاضافتها في ردود المكور ")
redis:set(bot_id.."Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
elseif text == "حذف رد للكل" and Dev_Apexr(msg) then 
send(msg.chat_id_, msg.id_,"𖨬︙ارسل الان الكلمه لحذفها من ردود المطور")
...
if (result.id_) then
if Dev_Apexr_User(result.id_) == true then
send(msg.chat_id_, msg.id_,"𖨬︙لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n𖨬︙تم تنزيل الشخص من الرتب التاليه \n𖨬︙{ "..dev..""..crr..""..cr..""..own..""..mod..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n𖨬︙ليس لديه رتب حتى استطيع تنزيله \n")
end
if Dev_Apexr_User(msg.sender_user_id_) == true then
redis:srem(bot_id.."Developer:Bot", result.id_)
redis:srem(bot_id.."President:Group"..msg.chat_id_,result.id_)
redis:srem(bot_id..'Constructor:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Manager:Group'..msg.chat_id_, result.id_)
...
send(msg.chat_id_, msg.id_,"𖨬︙رتبتك في البوت : "..rtp)
elseif text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
if result.first_name_  then
first_name = "𖨬︙اسمك الاول : `"..(result.first_name_).."`"
else
first_name = ""
end   
if result.last_name_ then 
last_name = "𖨬︙اسمك الثاني ← : `"..result.last_name_.."`" 
else
last_name = ""
end      
...
local taha = "𖨬︙عدد الادمنيه : "..data.administrator_count_..
"\n𖨬︙عدد المطرودين : "..data.kicked_count_..
"\n𖨬︙عدد الاعضاء : "..data.member_count_..
"\n𖨬︙عدد رسائل الكروب : "..(msg.id_/2097152/0.5)..
"\n𖨬︙اسم المجموعه : ["..ta.title_.."]"
...
send(msg.chat_id_, msg.id_,"𖨬︙تم حبيبي حغادر") 
...
send(msg.chat_id_, msg.id_,"𖨬︙تم حبيبي حغادر") 
send(GP_ID[2], 0,"𖨬︙تم مغادرة المجموعه بامر من مطور البوت") 
...
elseif text == "تغير اسم البوت" and Dev_Apexr(msg) or text == "تغيير اسم البوت" and Dev_Apexr(msg) then 
redis:setex(bot_id.."Change:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"𖨬︙ارسل لي الاسم الان ")  
elseif text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and DeveloperBot(msg) then 
if redis:get(bot_id.."Status:Broadcasting:Bot") and not Dev_Apexr(msg) then 
send(msg.chat_id_, msg.id_,"𖨬︙تم تعطيل الاذاعه من قبل المطور الاساسي !")
return false end
redis:setex(bot_id.."Broadcasting:Users" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"𖨬︙ارسل لي المنشور الان\n𖨬︙يمكنك ارسال -{ صوره - ملصق - متحركه - رساله }\n𖨬︙لالغاء الاذاعه ارسل : الغاء") 
return false
...
send(msg.chat_id_, msg.id_,"*\n𖨬︙اعدادات المجموعه "..
"\n••━━⎙━━━━⎙━━••"..
"\n𖨬︙علامة ال (✔️) تعني مفعل"..
"\n𖨬︙علامة ال (✖) تعني معطل"..
"\n••━━⎙━━━━⎙━━••"..
"\n𖨬︙الروابط "..lock_links..
"\n".."𖨬︙الكلايش "..lock_spam..
"\n".."𖨬︙الكيبورد "..lock_inlin..
"\n".."𖨬︙الاغاني "..lock_vico..
"\n".."𖨬︙المتحركه "..lock_gif..
"\n".."𖨬︙الملفات "..lock_file..
"\n".."𖨬︙الدردشه "..lock_text..
...
"\n••━━⎙━━━━⎙━━••"..
"\n".."𖨬︙التثبيت "..lock_pin..
"\n".."𖨬︙الاشعارات "..lock_tagservr..
"\n".."𖨬︙الماركدون "..lock_mark..
"\n".."𖨬︙التعديل "..lock_edit..
"\n".."𖨬︙الالعاب "..lock_geam..
"\n".."𖨬︙التكرار "..flood..
"\n••━━⎙━━━━⎙━━••"..
...
"\n".."𖨬︙الطرد "..Banusers..
"\n".."𖨬︙الايدي "..IdPhoto..
"\n".."𖨬︙الايدي بالصوره "..IdPyPhoto..
"\n".."𖨬︙اطردني "..KickMe..
"\n".."𖨬︙ردود المدير "..ReplyManager..
"\n".."𖨬︙ردود المطور "..ReplySudo..
"\n".."𖨬︙اوامر التحشيش "..FunGroup..
"\n".."𖨬︙جلب الرابط "..Link_Group..
"\n".."𖨬︙عدد التكرار ← {"..Num_Flood.."}\n\n.*")     
elseif text == 'تعين الايدي' and Owner(msg) then
redis:setex(bot_id.."Redis:Id:Group"..msg.chat_id_..""..msg.sender_user_id_,240,true)  
send(msg.chat_id_, msg.id_,[[
𖨬︙ارسل الان النص
𖨬︙يمكنك اضافه :
𖨬︙`#username` » اسم المستخدم
𖨬︙`#msgs` » عدد الرسائل
𖨬︙`#photos` » عدد الصور
𖨬︙`#id` » ايدي المستخدم
𖨬︙`#auto` » نسبة التفاعل
𖨬︙`#stast` » رتبة المستخدم 
𖨬︙`#edit` » عدد السحكات
𖨬︙`#game` » عدد المجوهرات
𖨬︙`#AddMem` » عدد الجهات
𖨬︙`#Description` » تعليق الصوره
𖨬︙قناة الكلايش • @Apexrcil
]])
return false  
...
send(msg.chat_id_, msg.id_,'𖨬︙تم تغير الايدي ارسل ايدي لرؤيته')
end
...
sendPhoto(msg.chat_id_,msg.id_,taha.photos_[0].sizes_[1].photo_.persistent_id_,'𖨬︙'..Description..'\n𖨬︙ايديك ← '..Id..'\n𖨬︙معرفك ← '..UserName_User..'\n𖨬︙رتبتك ← '..Status_Gps..'\n𖨬︙رسائلك ← '..NumMsg..'\n𖨬︙السحكات ← '..NumMessageEdit..' \n𖨬︙تفاعلك ← '..TotalMsg..'\n𖨬︙مجوهراتك ← '..Num_Games)
end
else
send(msg.chat_id_, msg.id_,'\n*𖨬︙ايديك ← '..Id..'\n𖨬︙معرفك ← *['..UserName_User..']*\n𖨬︙رتبتك ← '..Status_Gps..'\n𖨬︙رسائلك ← '..NumMsg..'\n𖨬︙السحكات ← '..NumMessageEdit..' \n𖨬︙تفاعلك ← '..TotalMsg..'\n𖨬︙مجوهراتك ← '..Num_Games..'*') 
end
...
send(msg.chat_id_, msg.id_,'𖨬︙تستطيع حذف *(1000)* رساله فقط') 
return false  
end  
...
send(msg.chat_id_, msg.id_,'𖨬︙تم ازالة *- '..Msg_Num..'* رساله من المجموعه')  
...
if data.first_name_ == false then
send(msg.chat_id_, msg.id_,'𖨬︙الحساب محذوف لا توجد معلوماته ')
return false
end
if data.username_ then
UserName_User = '@'..data.username_
...
send(msg.chat_id_, msg.id_,'\n*𖨬︙ايديه ← '..Id..'\n𖨬︙رسائله ← '..NumMsg..'\n𖨬︙معرفه ← *['..UserName_User..']*\n𖨬︙تفاعله ← '..TotalMsg..'\n𖨬︙رتبته ← '..Status_Gps..'\n𖨬︙تعديلاته ← '..NumMessageEdit..'\n𖨬︙جهاته ← '..Add_Mem..'*') 
end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Status, nil)
return false
...
send(msg.chat_id_, msg.id_,'𖨬︙لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_,"𖨬︙اسرع واحد يدز هاذا السمايل ? ~ {`"..SM.."`}")
return false
end
...
send(msg.chat_id_, msg.id_,"𖨬︙اسرع واحد يرتبها ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"𖨬︙اسرع واحد يحل الحزوره ↓\n {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"𖨬︙اسرع واحد يدز معنى السمايل ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"𖨬︙اسرع واحد يدز العكس ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"\n𖨬︙اهلا بك عزيزي في لعبة التخمين :\nٴ••━━⎙━━━━⎙━━••\n".."𖨬︙ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n".."𖨬︙سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ ")
...
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
𖨬︙اختر لأستخراج المحيبس الايد التي تحمل المحيبس 
𖨬︙الفائز يحصل على { 3 } من النقاط *
]])
...
name = string.gsub(name,"⌛️","⏳⏳⏳⏳⏳⏳⌛️⏳⏳")
name = string.gsub(name,"📅","??📆📆📆📆📆📅📆📆")
send(msg.chat_id_, msg.id_,"𖨬︙اسرع واحد يدز الاختلاف ~ {"..name.."}")
return false
end
...
send(msg.chat_id_, msg.id_,"𖨬︙اسرع واحد يكمل المثل ~ {"..name.."}")
return false
end
...
⋙ [Channel Source ،](t.me/Apexrcil)

⋙ [Files Source](t.me/ApexrFiles)
...
send(msg.chat_id_, msg.id_,[[*
𖨬︙توجد ← 5 اوامر في البوت
••━━⎙━━━━⎙━━••
𖨬︙ارسل { م1 } ← اوامر الحمايه
𖨬︙ارسل { م2 } ← اوامر الادمنيه
𖨬︙ارسل { م3 } ← اوامر المدراء
𖨬︙ارسل { م4 } ← اوامر المنشئين
𖨬︙ارسل { م5 } ← اوامر مطورين البوت
••━━⎙━━━━⎙━━••
𖨬︙قناة البوت ←* @Apexrcil
]]) 
elseif text == 'م1' and Admin(msg) then
send(msg.chat_id_, msg.id_,[[*
𖨬︙اوامر الحمايه اتبع مايلي ...
••━━⎙━━━━⎙━━••
𖨬︙قفل ، فتح ← الامر 
𖨬︙تستطيع قفل حمايه كما يلي ...
𖨬︙← { بالتقيد ، بالطرد ، بالكتم }
••━━⎙━━━━⎙━━••
𖨬︙الروابط
𖨬︙المعرف
𖨬︙التاك
...
send(msg.chat_id_, msg.id_,[[*
𖨬︙اوامر ادمنية المجموعه ...
••━━⎙━━━━⎙━━••
𖨬︙رفع، تنزيل ← مميز
𖨬︙تاك للكل ، عدد الكروب
𖨬︙كتم ، حظر ، طرد ، تقيد
𖨬︙الغاء كتم ، الغاء حظر ، الغاء تقيد
𖨬︙منع ، الغاء منع 
••━━⎙━━━━⎙━━••
𖨬︙عرض القوائم كما يلي ...
••━━⎙━━━━⎙━━••
𖨬︙المكتومين
𖨬︙المميزين 
𖨬︙قائمه المنع
...
𖨬︙الرابط ، الاعدادات
𖨬︙الترحيب ، القوانين
𖨬︙تفعيل ، تعطيل ← الترحيب
𖨬︙تفعيل ، تعطيل ← الرابط
𖨬︙اضف صلاحيه ، مسح صلاحيه 
𖨬︙جهاتي ،ايدي ، رسائلي
𖨬︙سحكاتي ، مجوهراتي
𖨬︙كشف البوتات
••━━⎙━━━━⎙━━••
𖨬︙وضع ، ضع ← الاوامر التاليه 
𖨬︙اسم ، رابط ، صوره
𖨬︙قوانين ، وصف ، ترحيب
••━━⎙━━━━⎙━━••
𖨬︙حذف ، مسح ← الاوامر التاليه
𖨬︙قائمه المنع ، المحظورين 
𖨬︙المميزين ، المكتومين ، القوانين
𖨬︙المطرودين ، البوتات ، الصوره
𖨬︙الصلاحيات ، الرابط
••━━⎙━━━━⎙━━••
𖨬︙قناة البوت ←* @Apexrcil
]]) 
...
send(msg.chat_id_, msg.id_,[[*
𖨬︙اوامر المدراء في المجموعه
••━━⎙━━━━⎙━━••
𖨬︙رفع ، تنزيل ← ادمن
𖨬︙الادمنيه 
𖨬︙رفع، كشف ← القيود
𖨬︙تنزيل الكل ← { بالرد ، بالمعرف }
••━━⎙━━━━⎙━━••
𖨬︙لتغيير رد الرتب في البوت
••━━⎙━━━━⎙━━••
𖨬︙تغير رد ← {اسم الرتبه والنص} 
𖨬︙المطور ، المنشئ الاساسي
𖨬︙المنشئ ، المدير ، الادمن
𖨬︙المميز ، العضو
••━━⎙━━━━⎙━━••
𖨬︙تفعيل ، تعطيل ← الاوامر التاليه ↓
••━━⎙━━━━⎙━━••
𖨬︙الايدي ، الايدي بالصوره
𖨬︙ردود المطور ، ردود المدير
𖨬︙اطردني ، الالعاب ، الرفع
𖨬︙الحظر ، الرابط ، اوامر التحشيش
••━━⎙━━━━⎙━━••
𖨬︙تعين ، مسح ←{ الايدي }
𖨬︙رفع الادمنيه ، مسح الادمنيه
𖨬︙ردود المدير ، مسح ردود المدير
𖨬︙اضف ، حذف ← { رد }
𖨬︙تنظيف ← { عدد }
••━━⎙━━━━⎙━━••
𖨬︙قناة البوت ←* @Apexrcil
...
send(msg.chat_id_, msg.id_,[[*
𖨬︙اوامر المنشئ الاساسي
••━━⎙━━━━⎙━━••
𖨬︙رفع ، تنزيل ←{ منشئ }
𖨬︙المنشئين ، مسح المنشئين
••━━⎙━━━━⎙━━••
𖨬︙اوامر المنشئ المجموعه
••━━⎙━━━━⎙━━••
𖨬︙رفع ، تنزيل ← { مدير }
𖨬︙المدراء ، مسح المدراء
𖨬︙اضف رسائل ← { بالرد او الايدي }
𖨬︙اضف مجوهرات ← { بالرد او الايدي }
𖨬︙اضف ، حذف ← { امر }
𖨬︙الاوامر المضافه ، مسح الاوامر المضافه
••━━⎙━━━━⎙━━••
𖨬︙قناة البوت ←* @Apexrcil
]]) 
elseif text == 'م5' and DeveloperBot(msg)  then
send(msg.chat_id_, msg.id_,[[*
𖨬︙اوامر المطور الاساسي  
••━━⎙━━━━⎙━━••
𖨬︙حظر عام ، الغاء العام
𖨬︙اضف ، حذف ← { مطور } 
𖨬︙قائمه العام ، مسح قائمه العام
𖨬︙المطورين ، مسح المطورين
••━━⎙━━━━⎙━━••
𖨬︙اضف ، حذف ← { رد للكل }
𖨬︙وضع ، حذف ← { كليشه المطور } 
𖨬︙مسح ردود المطور ، ردود المطور 
𖨬︙تحديث ،  تحديث السورس 
𖨬︙تعين عدد الاعضاء ← { العدد }
••━━⎙━━━━⎙━━••
𖨬︙تفعيل ، تعطيل ← { الاوامر التاليه ↓}
𖨬︙البوت الخدمي ، المغادرة ، الاذاعه
𖨬︙ملف ← { اسم الملف }
••━━⎙━━━━⎙━━••
𖨬︙مسح جميع الملفات 
𖨬︙المتجر ، الملفات
••━━⎙━━━━⎙━━••
𖨬︙اوامر المطور في البوت
••━━⎙━━━━⎙━━••
𖨬︙تفعيل ، تعطيل ، الاحصائيات
𖨬︙رفع، تنزيل ← { منشئ اساسي }
𖨬︙مسح الاساسين ، المنشئين الاساسين 
𖨬︙غادر ، غادر ← { والايدي }
𖨬︙اذاعه ، اذاعه بالتوجيه ، اذاعه بالتثبيت
𖨬︙اذاعه خاص ، اذاعه خاص بالتوجيه 
••━━⎙━━━━⎙━━••
𖨬︙قناة البوت ←* @Apexrcil
]]) 
elseif text == 'الالعاب' then
send(msg.chat_id_, msg.id_,[[*
𖨬︙قائمه الالعاب البوت
••━━⎙━━━━⎙━━••
𖨬︙لعبة المختلف » المختلف
𖨬︙لعبة الامثله » امثله
𖨬︙لعبة العكس » العكس
𖨬︙لعبة الحزوره » حزوره
𖨬︙لعبة المعاني » معاني
𖨬︙لعبة البات » بات
𖨬︙لعبة التخمين » خمن
𖨬︙لعبه الاسرع » الاسرع
𖨬︙لعبة السمايلات » سمايلات
••━━⎙━━━━⎙━━••
𖨬︙مجوهراتي ← لعرض عدد الارباح
𖨬︙بيع مجوهراتي ← { العدد } ← لبيع كل مجوهره مقابل {50} رساله
*]]) 
elseif text == 'رسائلي' then
local NumMsgg1 = redis:get(bot_id..'Num:Message:Userr'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local nummsg = redis:get(bot_id..'Num:Message:User'..msg.chat_id_..':'..msg.sender_user_id_) or 1 
local NumMsg = (NumMsgg1 + nummsg)
send(msg.chat_id_, msg.id_,'𖨬︙عدد رسائلك هنا *~ '..NumMsg..'*') 
...
send(msg.chat_id_,msg.id_,"𖨬︙تم خصم *~ { "..NUMPY.." }* من مجوهراتك \n𖨬︙وتم اضافة* ~ { "..(NUMPY * 50).." } رساله الى رسالك *")
end 
return false 
...
send(msg.chat_id_, msg.id_, "𖨬︙ارسل لي عدد الرسائل الان") 
return false
...
send(msg.chat_id_, msg.id_, "𖨬︙ارسل لي عدد المجوهرات الان") 
elseif text and text:match("^اضف مجوهرات (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
function reply(extra, result, success)
redis:incrby(bot_id.."Num:Add:Games"..msg.chat_id_..result.sender_user_id_,text:match("^اضف مجوهرات (%d+)$"))  
send(msg.chat_id_, msg.id_,"𖨬︙تم اضافه عدد مجوهرات : "..text:match("^اضف مجوهرات (%d+)$").." ")  
end
...
send(msg.chat_id_, msg.id_, "𖨬︙تم اضافه عدد الرسائل : "..text:match("^اضف رسائل (%d+)$").." ")  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
elseif text == "تنظيف المشتركين" and Dev_Apexr(msg) then
local pv = redis:smembers(bot_id..'Num:User:Pv')  
local sendok = 0
for i = 1, #pv do
tdcli_function({ID='GetChat',chat_id_ = pv[i]},function(arg,dataq)
...
return false
elseif text == "تنظيف الكروبات" and Dev_Apexr(msg) then
local group = redis:smembers(bot_id..'ChekBotAdd')  
local w = 0
local q = 0
for i = 1, #group do
...
send(msg.chat_id_, msg.id_, "\n𖨬︙عذرا لا استطيع طرد ( "..Get_Rank(msg.sender_user_id_,msg.chat_id_).." )")
return false
end
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=msg.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,"𖨬︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
return false  
end
...
send(msg.chat_id_, msg.id_,"𖨬︙عذرا لا استطيع طرد ادمنية المجموعه") 
return false  
end
if data and data.ID and data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"𖨬︙تم طردك من المجموعه ") 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,"𖨬︙امر اطردني تم تعطيله من قبل المدراء ") 
end
...
send(msg.chat_id_, msg.id_,"𖨬︙الحظر العام ← "..GBan.."\n𖨬︙الحظر ← "..Ban.."\n𖨬︙الكتم ← "..Muted)
else
send(msg.chat_id_, msg.id_,"𖨬︙المعرف غلط")
end
end
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"𖨬︙لا توجد ادمنية ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_,"𖨬︙تمت ترقية - "..num2.." من ادمنية المجموعه") 
end
end,nil)   
...
if b.first_name_ == false then
send(msg.chat_id_, msg.id_,"𖨬︙حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "Apexrcil")
send(msg.chat_id_, msg.id_,"𖨬︙منشئ المجموعه ~ ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
local UserName = (b.username_ or "Apexrcil")
send(msg.chat_id_, msg.id_,"𖨬︙تم ترقية منشئ المجموعه ← ["..b.first_name_.."](T.me/"..UserName..")")  
redis:sadd(bot_id.."President:Group"..msg.chat_id_,b.id_)
end,nil)   
end,nil)   
elseif text and text:match("^تعين عدد الاعضاء (%d+)$") and Dev_Apexr(msg) then
redis:set(bot_id..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
send(msg.chat_id_, msg.id_,'*𖨬︙تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *')
elseif text =='الاحصائيات' and DeveloperBot(msg) then 
send(msg.chat_id_, msg.id_,'*𖨬︙عدد احصائيات البوت الكامله \n••━━⎙━━━━⎙━━••\n𖨬︙عدد المجموعات : '..(redis:scard(bot_id..'ChekBotAdd') or 0)..'\n𖨬︙عدد المشتركين : '..(redis:scard(bot_id..'Num:User:Pv') or 0)..'*')
elseif text == 'المطور' or text == 'مطور' then
local TextingDevApexr = redis:get(bot_id..'Texting:DevApexr')
if TextingDevApexr then 
send(msg.chat_id_, msg.id_,TextingDevApexr)
else
send(msg.chat_id_, msg.id_,'['..UserName_Dev..']')
end
elseif text == 'حذف كليشه المطور' and Dev_Apexr(msg) then
redis:del(bot_id..'Texting:DevApexr')
send(msg.chat_id_, msg.id_,'𖨬︙تم حذف كليشه المطور')
end
end
...
if TypeForChat ~= 'ForSuppur' then
send(msg.chat_id_, msg.id_,'𖨬︙يجب تحويل المجموعة الى خارقة. او وضع معرف للمجموعه لتصبح عامه ثم ارفع البوت وارسل تفعيل⚙️') 
return false
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'𖨬︙البوت ليس ادمن يرجى ترقيتي !') 
...
tdcli_function ({ ID = "GetChannelFull", channel_id_ = msg.chat_id_:gsub("-100","")}, function(arg,data)  
if tonumber(data.member_count_) < tonumber(redis:get(bot_id..'Num:Add:Bot') or 0) and not Dev_Apexr(msg) then
send(msg.chat_id_, msg.id_,'𖨬︙لا تستطيع تفعيل المجموعه بسبب قلة عدد اعضاء المجموعه يجب ان يكون اكثر من *:'..(redis:get(bot_id..'Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if redis:sismember(bot_id..'ChekBotAdd',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'𖨬︙تم تفعيل المجموعه مسبقا')
else
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
...
Send_Options(msg,result.id_,'reply_Add','𖨬︙تم تفعيل مجموعه '..chat.title_..'')
...
if not Dev_Apexr(msg) then
sendText(Id_Dev,'𖨬︙تم تفعيل مجموعه جديده\n'..'\n𖨬︙بواسطة : '..Name..''..'\n𖨬︙ايدي المجموعه : `'..IdChat..'`'..'\n𖨬︙عدد اعضاء المجموعه *: '..NumMember..'*'..'\n𖨬︙اسم المجموعه : ['..NameChat..']'..'\n𖨬︙الرابط : ['..LinkGp..']',0,'md')
end
end
end,nil) 
end,nil) 
...
send(msg.chat_id_, msg.id_,'𖨬︙المجموعه بالتاكيد معطله')
else
Send_Options(msg,result.id_,'reply_Add','𖨬︙تم تعطيل مجموعه '..chat.title_..'')
redis:srem(bot_id..'ChekBotAdd',msg.chat_id_)  
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub('"',"") 
...
if not Dev_Apexr(msg) then
sendText(Id_Dev,'𖨬︙تم تعطيل مجموعه جديده\n'..'\n𖨬︙بواسطة : '..Name..''..'\n𖨬︙ايدي المجموعه : `'..IdChat..'`\n𖨬︙اسم المجموعه : ['..NameChat..']',0,'md')
end
end
end,nil) 
end,nil) 
...
Send_Options(msg,msg.sender_user_id_,'reply_Add','𖨬︙تم تفعيل مجموعه '..chat.title_..'')
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
...
local NameChat = NameChat:gsub("}","") 
if not Dev_Apexr(msg) then
sendText(Id_Dev,'𖨬︙تم تفعيل مجموعه جديده\n𖨬︙بواسطة : '..Name..'\n𖨬︙موقعه في المجموعه : '..Status_Rt..'\n𖨬︙ايدي المجموعه : `'..msg.chat_id_..'`\n𖨬︙عدد اعضاء المجموعه *: '..NumMember..'*\n𖨬︙اسم المجموعه : ['..NameChat..']\n𖨬︙الرابط : ['..LinkChat..']',0,'md')
end
end
end
end,nil)   
...
send(msg.chat_id_, msg.id_,"𖨬︙تم ازالة هاذا ← { "..text.." }")  
else
send(msg.chat_id_, msg.id_,"𖨬︙لا يوجد امر بهاذا الاسم")  
end
...
send(msg.chat_id_, msg.id_,"𖨬︙ارسل الامر الجديد ليتم وضعه مكان القديم")  
...
send(msg.chat_id_, msg.id_,"𖨬︙تم حفظ الامر باسم ← { "..text..' }')  
...
--------------------------------------------------------------------------------------------------------------
Dev_Apexr_File(msg,data)
FilesApexrBot(msg,data)
...
if #list == 0 then
Send_Options(result,result.sender_user_id_,"reply","𖨬︙قام بالتعديل على الميديا")  
else
tt = "\n𖨬︙يا منشئين\n••━━⎙━━━━⎙━━•• \n"
for k,v in pairs(list) do
local username = redis:get(bot_id.."Save:Username" .. v)
...
if Text_Filter then    
Delete_Message(result.chat_id_, {[0] = data.message_id_})     
Send_Options(result,result.sender_user_id_,"reply","𖨬︙"..Text_Filter)  
return false
end
end
end
